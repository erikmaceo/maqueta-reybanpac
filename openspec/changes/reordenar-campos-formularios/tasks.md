...
- [ ] 4.2 Verificar visualmente en rutas nuevo/editar de las tres entidades que los campos quedan en filas de dos según el requerimiento, `Descripción` al final, y sin cambios en validaciones ni búsquedas.